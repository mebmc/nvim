...
keymap.set("n", "<leader>xc", "<cmd>cclose<cr>", { desc = "close quickfix" })
keymap.set("n", "H", "<cmd>cfirst<cr>", { desc = "first quickfix item" })
keymap.set("n", "J", "<cmd>cnext<cr>", { desc = "next quickfix item" })
keymap.set("n", "K", "<cmd>cprev<cr>", { desc = "previous quickfix item" })
keymap.set("n", "L", "<cmd>clast<cr>", { desc = "last quickfix item" })
